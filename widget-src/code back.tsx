...
//Both the height and width need to be divisable by 3.
//Choose height number first then times by around 1.25 to get the width
...
function PropertyMenuWidget() {
  ...
  const [fillColor, setFillColor] = useSyncedState("fillColor", "#ffffff");
  ...
  const typeOptions = [
    ...
    { option: "frontend", label: "Frontend" },
    { option: "backend", label: "Backend" },
    { option: "user", label: "User" },
    { option: "admin", label: "Admin" },
    { option: "network", label: "Network" },
    { option: "isp", label: "ISP" },
  ...
  usePropertyMenu(
    [
      ...
      //   propertyName: "fillColors",
      //   tooltip: "Fill selector",
      //   checked: fillColor === "#CCCCCC", // Set to true if fillColor is "#CCCCCC", false otherwise
      //   options: [
      //     { label: "Mid Grey", value: "#CCCCCC" },
      //     { label: "Slate", value: "#757575" }
      //   ]
      // },
    ...
    ({ propertyName, propertyValue }) => {
      ...
      else if (propertyName === "fillColors") {
        setFillColor(propertyValue);
      } 
